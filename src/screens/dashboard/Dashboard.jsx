...
//           <div className="px-6 py-6 rounded-lg border-l-4 border-green-500 w-full flex flex-row justify-between items-center gap-x-[9em] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
//             <div className="flex flex-col justify-start items-start">
//               <p className="text-sm text-gray-500">Total Expenses</p>
//               <p className="text-3xl font-semibold">617</p>
//             </div>
//             <p className="text-green-600 bg-green-100 px-3 py-3 rounded-lg">
//               <BsBank size={22} />
//             </p>
//           </div>

//           <div className="px-6 py-6 rounded-lg border-l-4 border-green-500 flex flex-row justify-between items-center gap-x-[9em] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
//             <div className="flex flex-col justify-start items-start">
//               <p className="text-sm text-gray-500">Approved Expenses</p>
//               <p className="text-3xl font-semibold">718</p>
//             </div>
//             <p className="text-green-600 bg-green-100 px-3 py-3 rounded-lg">
...
const Dashboard = () => {
  ...
  const getStatusStyles = (status) => ({
    backgroundColor: status === "Active" ? "#DFF0EA" : "#f8d7da",
    color: status === "Active" ? "#22B470" : "#721c24", // Changed to #2634bb for active status
    borderRadius: "4px",
    padding: "4px 8px",
    textAlign: "center",
    fontWeight: "bold",
  ...
  return (
    <>
      <div className="flex flex-col justify-start items-start">
        ...
        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1em] md:gap-[2em] mt-[1em] md:mt-[2em] mb-[1em] md:mb-[2em] w-full">
          <div className="px-6 py-6 rounded-lg border-l-4 border-[#2634bb] w-full flex flex-row justify-between items-center gap-x-[9em] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
            <div className="flex flex-col justify-start items-start">
              <p className="text-sm text-gray-500">Total Expenses</p>
              <p className="text-3xl font-semibold">617</p>
            </div>
            <p className="text-[#2634bb] bg-[#DFF0EA] px-3 py-3 rounded-lg">
              <BsBank size={22} />
            </p>
          </div>

          <div className="px-6 py-6 rounded-lg border-l-4 border-[#2634bb] flex flex-row justify-between items-center gap-x-[9em] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
            <div className="flex flex-col justify-start items-start">
              <p className="text-sm text-gray-500">Approved Expenses</p>
              <p className="text-3xl font-semibold">718</p>
            </div>
