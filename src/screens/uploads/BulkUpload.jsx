      ...
      <div className="flex flex-row justify-between items-center gap-x-[2em] h-[80vh]">
        <div className="w-[60%] p-8 rounded-lg  mr-8">
          <div className="flex flex-row justify-between items-center border-2 border-[#E6E7EA] bg-[#F8F8F8] rounded-lg px-4 py-2 mb-6">
            ...
            <ReusableButton outlined={true} className="ml-auto">
              Download
            </ReusableButton>
          </div>
          ...
          <div className="flex flex-col justify-center items-center mt-4">
            ...
            <ReusableButton
              ...
              className={`w-fit ${
                !selectedFile ? "bg-gray-300" : "bg-green-500 text-white"
              }`}
            >
              Upload
            </ReusableButton>
        ...
        <div className="w-[30%] border-dotted border-2 border-green-500 p-8 rounded-lg">
