  ...
  const renderTabs = () => (
    <div className="relative flex items-center w-full gap-4 mb-4">
      <button
        className={`py-1 ${
          selectedTab === "users"
            ? "border-b-[3px] border-custom-blue text-custom-blue"
            : "text-gray-500"
        }`}
    ...
    <div>
      ...
      {isModalOpen && (
        <ReusableModal
          ...
          heading={`Add New ${selectedTab === "users" ? "User" : "Team"}`}
          submitText="Save"
          cancelText="Cancel"
        ...
        >
          {selectedTab === "users" ? (
            ...
            <div className="grid grid-cols-1 gap-x-4">
              <ReusableInput label="Team Name" placeholder="Team Name" />
              <ReusableInput
